...
<section class="reactions">
	<h3><?php echo esc_html_e( 'Reacjis', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type' => 'reacji',
...
<section class="likes">
	<h3><?php echo esc_html_e( 'Likes', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'like',
...
<section class="favorites">
	<h3><?php echo esc_html_e( 'Favourites', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'favorite',
...
<section class="bookmarks">
	<h3><?php echo esc_html_e( 'Bookmarks', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'bookmark',
...
<section class="reposts">
	<h3><?php echo esc_html_e( 'Reposts', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'repost',
...
<section class="tags">
	<h3><?php echo esc_html_e( 'Tags', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'tag',
...
<section class="listens">
	<h3><?php echo esc_html_e( 'Listening', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'listen',
...
<section class="reads">
	<h3><?php echo esc_html_e( 'Reading', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'read',
...
<section class="fullows">
	<h3><?php echo esc_html_e( 'Fullowing', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'fullow',
...
<section class="watches">
	<h3><?php echo esc_html_e( 'Watching', 'semantic-linkbacks' ); ?></h3>
	<?php
		list_linkbacks(
			array(
				'type'        => 'watch',
...
<section class="rsvps">
	<h3><?php esc_html_e( 'RSVPs', 'semantic-linkbacks' ); ?></h3>

	<?php if ( in_array( 'rsvp:yes', $facepiles, true ) && has_linkbacks( 'rsvp:yes' ) ) : ?>
	<h4><?php esc_html_e( 'Yes', 'semantic-linkbacks' ); ?></h4>
		<?php
			list_linkbacks(
				array(
					'type'        => 'rsvp-yes',
	...
	<h4><?php esc_html_e( 'Invited', 'semantic-linkbacks' ); ?></h4>
		<?php
			list_linkbacks(
				array(
					'type'        => 'invited',
	...
	<h4><?php esc_html_e( 'Maybe', 'semantic-linkbacks' ); ?></h4>
		<?php
			list_linkbacks(
				array(
					'type'        => 'rsvp-maybe',
	...
	<h4><?php esc_html_e( 'No', 'semantic-linkbacks' ); ?></h4>
		<?php
			list_linkbacks(
				array(
					'type'        => 'rsvp-no',
...
<section class="mentions">
	<h3><?php echo esc_html_e( 'Mentions', 'semantic-linkbacks' ); ?></h3>
	<?php
	list_linkbacks(
		array(
			'type'        => 'mention',
