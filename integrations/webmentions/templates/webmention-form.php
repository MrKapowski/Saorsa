<section class="comment--webmention">
	...
	<form id="webmention-form" class="comment--webmention--form" action="<?php echo esc_url( get_webmention_endpoint() ); ?>" method="post">
		<input id="webmention-source" type="url" name="source" class="comment--webmention--source" placeholder="<?php esc_attr_e( 'URL/Permalink of your article', 'webmention' ); ?>" />
		<button id="webmention-submit" type="submit" name="submit" class="comment--webmention--submit"><?php esc_html_e( 'Ping me!', 'webmention' ); ?></button>
