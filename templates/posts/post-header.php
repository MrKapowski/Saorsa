<header class="post--header">
	...
	<h1 class="post--title <?php saorsa_header_class(); ?> p-name" itemprop="headline">
								<a href="<?php the_permalink(); ?>" rel="permalink" class="u-url u-uid" title="<?php the_title_attribute(); ?>">
							...
							<section class="post--metabox">
								<time class="post--metabox--published dt-published" itemprop="datePublished" datetime="<?php echo esc_attr( get_the_time( 'c' ) ); ?>">
